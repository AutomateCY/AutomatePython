...
def modify_aef(automaton):
    while True:
        ...
        if choice == '1':
            ...
            symbol = input("Transition symbol: ")
            end_state = input("Ending state: ")
            if start_state in automaton['transitions'] and symbol in automaton['transitions'][start_state] and \
                    automaton['transitions'][start_state][symbol] == end_state:
    ...
    # You can then use the modified automaton as needed; TODO put the correct "print" function
